...
if __name__ == "__main__":
    ...
    history_length = 5
    agent = BCAgent()
    agent.load(f"/project/dl2025s/biswass/DLL_25_IL_RL_Exercise/models/agent.pt")
    ...
    fname = f"results/results_bc_agent_{history_length}-{datetime.now().strftime('%Y%m%d-%H%M%S')}.json"
    fh = open(fname, "w")
